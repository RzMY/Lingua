...
Lingua 是一个面向语言学习的播放器。它把音频、字幕、逐词时间轴、注音、转写、词性、译文和词汇讲解放在同一条学习流程。支持日语、英语、西班牙语、法语、德语和韩语。
## 功能概览

- 本地导入音频：WAV、MP3、M4A、FLAC、OGG、OPUS 等浏览器支持的格式。
...
- IndexedDB 本地保存音频、分析结果与大模型产物；支持用户数据导出、导入。
